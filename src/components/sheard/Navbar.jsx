...
function Navbar() {
  ...
  const menuItems = ["Dashboard", "Incidents", "Locations", "Activities","Documents","Cypher AI"];
          ...
          {isMobile ? (
            ...
            >
              <Typography sx={{ flexGrow: 1 }}>
                <img src={logo} alt="Logo" className="text-[#0FF1F6] md:w-full lg:w-36 min-h-10"   />
              </Typography>
                  ...
                  <div className="flex gap-2">
                    <div className="flex items-center gap-2">
                      <button className=" cursor-pointer " >
                        <img src="/navring.png" alt="" className="min-h-[50px] min-w-[50px]"/>
                      </button>
                      <button className=" cursor-pointer ">
                        <img src="/navpic.png" alt="" className="min-h-[50px] min-w-[50px]" />
                      </button>
