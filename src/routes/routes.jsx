...
import IncidentSevere from "../components/IncidentSevere";
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path:"/incidents/progress/NewIncident/CreateNewIncident/IncidentLocation/IncidentSevere",
        element:<IncidentSevere/>,
      },
